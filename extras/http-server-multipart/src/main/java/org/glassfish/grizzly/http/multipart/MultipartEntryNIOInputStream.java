 ...
 * @since 2.0.1
 */
public class MultipartEntryNIOInputStream extends NIOInputStream {

    private boolean isClosed;

//    private final ReadHandler parentReadHandler;
    private final MultipartEntry multipartEntry;
    private final NIOInputStream requestNIOInputStream;
...
//            final ReadHandler parentReadHandler,
            final NIOInputStream requestNIOInputStream) {
...
//
//        requestNIOInputStream.notifyAvailable(parentReadHandler,
//                requestNIOInputStream.readyData() + 1);
    }
