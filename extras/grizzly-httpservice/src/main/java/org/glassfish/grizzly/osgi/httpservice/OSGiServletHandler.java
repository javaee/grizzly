...
public class OSGiServletHandler extends ServletHandler implements OSGiHandler {
    ...
    public OSGiServletHandler(Servlet servlet, HttpContext httpContext, HashMap<String, String> initparams,
                              Logger logger) {
        super(null, new OSGiServletContext(httpContext, logger),
    ...
    private OSGiServletHandler(ServletContextImpl servletCtx,
                               Map<String, String> parameters, List<String> listeners, Logger logger) {
        super(null, servletCtx, new HashMap<String,String>(), parameters, listeners);
        this.logger = logger;
    }
     ...
     * {@inheritDoc}
     */
    @Override public OSGiServletHandler newServletHandler(Servlet servlet) {
        OSGiServletHandler servletHandler =
                new OSGiServletHandler(getServletCtx(),
                getContextParameters(), getListeners(), logger);
