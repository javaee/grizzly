...
public class AllocatorPoolImpl extends AllocatorBase {
    ...
    public AllocatorPoolImpl( final int headerSize, 
        final AllocatorFactory.SlabPool pool ) {
