...
public class AuthenticationTest {
    ...
    public static Option[] configuration() {
        return options(
                ...
                provision(
                        mavenBundle().groupId("com.sun.grizzly").artifactId("grizzly-http-servlet").version(
                                "1.9.6-SNAPSHOT"),
                        ...
                        mavenBundle().groupId("com.sun.grizzly").artifactId("grizzly-framework").version(
                                "1.9.6-SNAPSHOT"),
                        mavenBundle().groupId("com.sun.grizzly").artifactId("grizzly-portunif").version(
                                "1.9.6-SNAPSHOT"),
