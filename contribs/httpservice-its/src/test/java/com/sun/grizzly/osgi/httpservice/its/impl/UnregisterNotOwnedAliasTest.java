...
/**
 * Integration testing of unregistering not owned alias.
 *
 * @author Hubert Iwaniuk
 * @since Feb 9, 2009
 */
@RunWith(JUnit4TestRunner.class)
public class UnregisterNotOwnedAliasTest {
    ...
    public void unregisterNotOwnedAlias(final BundleContext bc) throws InterruptedException {
