...
public class ByteArrayClonerTest {
    ...
    public void testSimpleBuffer() {
        ...
        Buffer newBuffer = (Buffer) cloner.clone0(mm, buffer);
        clean(array);
        ...
        newBuffer = (Buffer) cloner.clone0(mm, buffer);
        clean(array);
    ...
    public void testSingleElementCompositeBuffer() {
        ...
        Buffer newBuffer = (Buffer) cloner.clone0(mm, cb);
        clean(array);
        checkContent(newBuffer, 'A');
        ...
        newBuffer = (Buffer) cloner.clone0(mm, cb);
        clean(array);
        assertEquals(array.length - offset, newBuffer.remaining());
        checkContent(newBuffer, 'A');
