 ...
 */
public class SelectorThreadStats extends TestCase {
    ...
    public void testKeepAlveConnection() throws IOException {
        createSelectorThread();
        String testString = "KAS:  conns=0, flushes=0, hits=0, refusals=0, timeouts=0, maxConns=8196, secTimeouts=30";
    ...
    public void testGetHits()  throws IOException {
        try{
            String testString = "KAS:  conns=0, flushes=0, hits=1, refusals=0, timeouts=0, maxConns=8196, secTimeouts=30";
    ...
    class MyAdapter implements Adapter
    {
        ...
        public synchronized void service(Request request, Response response) throws Exception
        {
            ...
            if (kas == null) {
                ...
                s = "KAS:  conns=" + kas.getCountConnections()
