...
public final class KeepAliveConfig implements MonitoringAware<KeepAliveProbe> {
     ...
     */
    public KeepAliveConfig(final KeepAliveConfig keepAliveConfig) {
        this.idleTimeoutInSeconds = keepAliveConfig.idleTimeoutInSeconds;
        this.maxRequestsCount = keepAliveConfig.maxRequestsCount;
    }
