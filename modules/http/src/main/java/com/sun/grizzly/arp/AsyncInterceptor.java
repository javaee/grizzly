...
/**
 * Determine if a request can be executed using an {@link AsyncHandler} or not.
 * @author Jeanfrancois Arcand
 */
public class AsyncInterceptor implements Interceptor<ByteBuffer,SocketChannel>{
   
    protected ArrayList<byte[]> allowed = new ArrayList<byte[]>();
    ...
    /**
     * Add a context-path that will be allowed to execute under {@link AsyncHandler}.
     * @param s a context-path that will be allowed to execute under {@link AsyncHandler}.
     */
    public void addContextPath(String s) {
        allowed.add(s.getBytes());
    }  
