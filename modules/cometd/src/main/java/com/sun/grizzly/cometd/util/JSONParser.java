...
public class JSONParser {
    ...
    private static void appendNull(StringBuilder buffer) {
        buffer.append("null");
    }

    private static void appendJSON(StringBuilder buffer, Generator generator) {
        generator.addJSON(buffer);
    }

    private static void appendMap(StringBuilder buffer, Map object) {
        if (object==null) {
            appendNull(buffer);
            return;
        }
    ...
    private static void appendBoolean(StringBuilder buffer, Boolean b) {
        if (b==null) {
            appendNull(buffer);
            return;
        }
    ...
    private static void appendNumber(StringBuilder buffer, Number number) {
        if (number==null) {
            appendNull(buffer);
            return;
        }
    ...
    private static void appendString(StringBuilder buffer, String string) {
        if (string==null) {
            appendNull(buffer);
            return;
        }
