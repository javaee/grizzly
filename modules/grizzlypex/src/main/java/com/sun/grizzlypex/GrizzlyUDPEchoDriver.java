 ...
 */
public class GrizzlyUDPEchoDriver extends GrizzlyJapexDriverBase
    ...
    public void prepare(TestCase testCase) {
        ...
        try {
            ...
            if (!((UDPConnectorHandler) connectorHandler).isConnected()) {
    ...
    public void run(TestCase testCase) {
        ...
        try {
            long writeCount = connectorHandler.write(sendData, false);
