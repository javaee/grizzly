...
public interface WebSocket {
    ...
    /**
     * Broadcasts the data to the set of sockets.  This text will be converted to a UTF-8 encoded byte[] prior to sending.
     *
     * @param data
     */
    ...
    /**
     * Broadcasts the data to the set of sockets.
     *
     * @param data
     */
