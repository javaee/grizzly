...
public class PingPongTest extends BaseWebSocketTestUtilities {
    ...
    @Test
    public void testAutoPingReply() throws Exception {
        WebSocketServer server = new WebSocketServer(PORT);
        server.register("/ping", new AutoReply());
        ...
        try {
            ...
            client.sendPing("ping".getBytes("UTF-8"));
    ...
    private static final class AutoReply extends WebSocketApplication {
        @Override
