...
public class AlternateDocBase {
    ...
    public void setUrlPattern(String urlPattern) {
        ...
        if (urlPattern.endsWith("/*")) {
            ...
            wildcardPath = urlPattern.substring(
