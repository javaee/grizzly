...
public class CompositeBufferTest {
    ...
    @Test
    public void testToViewByteBufferArray() {
        ...
        for (int i = 0; i < bytes.length; i++) {
            for (int j = i; j < bytes.length; j++) {
                final ByteBufferArray bbArray = composite.toViewByteBufferArray(i, j);
    ...
    @Test
    public void testToViewByteBuffer() {
        ...
        for (int i = 0; i < bytes.length; i++) {
            for (int j = i; j < bytes.length; j++) {
                final ByteBuffer bb = composite.toViewByteBuffer(i, j);
