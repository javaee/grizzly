 ...
 * cached. An ProtocolChainInstanceHandler decide if a stateless or statefull 
 * ProtocolChain needs to be created
 *
...
public interface ProtocolChainInstanceHandler extends Handler{
     ...
     * @param instance {@link ProtocolChain}
     * @return offer successful, (true / false) ?
     */
