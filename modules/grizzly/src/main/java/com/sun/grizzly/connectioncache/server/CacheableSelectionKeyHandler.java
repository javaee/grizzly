...
public class CacheableSelectionKeyHandler extends DefaultSelectionKeyHandler {
    ...
    public CacheableSelectionKeyHandler(int highWaterMark, int numberToReclaim) {
        inboundConnectionCache = ConnectionCacheFactory.<SelectableChannel>makeBlockingInboundConnectionCache(
    ...
    public void copyTo(Copyable copy) {
        super.copyTo(copy);
        CacheableSelectionKeyHandler copyHandler = 
                (CacheableSelectionKeyHandler) copy;
        copyHandler.inboundConnectionCache = inboundConnectionCache;
    }

    @Override
    public void process(SelectionKey key) {
        super.process(key);
        inboundConnectionCache.requestReceived(key.channel());
    }
    ...
    public void cancel(SelectionKey key) {
        super.cancel(key);
        inboundConnectionCache.close(key.channel());
    }    
}
