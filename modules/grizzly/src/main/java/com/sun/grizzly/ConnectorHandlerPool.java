 ...
 * allocating/releasing client side {@link ConnectorHandler}s
 * 
...
public interface ConnectorHandlerPool<E extends ConnectorHandler> {
    /**
     * Return an instance of {@link ConnectorHandler},
     * which corresponds to the protocol
     * @param protocol a {@link Controller.Protocol}
     ...
     * @param connectorHandler - a {@link ConnectorHandler}
     */
