...
/**
 * Smart {@link Codec}, which is able to encode/decode custom protocol message
...
public class SmartCodec<K> implements Codec<Buffer, K> {
    ...
    public SmartCodec(Class<K> clazz) {
        decoder = new SmartDecoderTransformer<K>(clazz);
        encoder = new SmartEncoderTransformer<K>(clazz);
    }
