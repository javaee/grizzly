 ...
 *     <li>Growth factor: 2 ({@link #DEFAULT_GROWTH_FACTOR}), which means the first buffer pool will contain buffers of size 4 KiB. The second will contain buffers of size 16KiB. The third will contain buffers of size 64KiB</li>
