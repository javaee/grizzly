 ...
 */
public class DefaultFilterChainCodec implements FilterChainCodec {
    ...
    public Transformer getDecoder(FilterChainContext context) {
        return new DefaultDecoderTransformer(context);
    }

    public Transformer getEncoder(FilterChainContext context) {
        return new DefaultEncoderTransformer(context);
    }

    public Transformer getDecoder() {
        return new DefaultDecoderTransformer(filterChain);
    }

    public Transformer getEncoder() {
        return new DefaultEncoderTransformer(filterChain);
    }
