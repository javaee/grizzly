...
public interface Buffer extends Comparable<Buffer>, WritableMessage {
    ...
    /**
     * <p>
     * Converts this <code>Buffer</code> to a {@link ByteBuffer}.  Changes
     * made this this {@link ByteBuffer} <em>will not</em> be visible to the source
     * <code>Buffer</code> and vice versa.
     * <p/>
     *
     * <p>
     ...
     * </p>
     *
     * @return a {@link ByteBuffer} insulated from changes from the source
     *  <code>Buffer</code>.
     */
    ...
    /**
     * <p>
     * Converts this <code>Buffer</code> to a {@link ByteBuffer} based on the
     * provided <code>position</code> and <code>limit</code> arguments.  Changes
     * made this this {@link ByteBuffer} <em>will not</em> be visible to the source
     * <code>Buffer</code> and vice versa.
     * <p/>
     *
     ...
     * <p>
     * Converts this <code>Buffer</code> to a {@link ByteBuffer}.  Changes
     * made this this {@link ByteBuffer} <em>will</em> be visible to the source
     * <code>Buffer</code> and vice versa.
     * <p/>
     *
     * <p>
     ...
     * </p>
     *
     * @return a {@link ByteBuffer} view of this <code>Buffer</code>.
     *
     * @since 2.1.2
     */
    ByteBuffer toViewByteBuffer();
     ...
     * @since 2.1.2
     */
    ByteBuffer toViewByteBuffer(int position, int limit);
    ...
    /**
     * <p>
     * Converts this <code>Buffer</code> to a {@link ByteBuffer} per {@link #toViewByteBuffer()}
     * and returns a {@link ByteBufferArray} containing the converted {@link ByteBuffer}.
     * </p>
     *
     * @return Converts this <code>Buffer</code> to a {@link ByteBuffer} per {@link #toViewByteBuffer()}
     *         and returns a {@link ByteBufferArray} containing the converted {@link ByteBuffer}.
     *
     * @see {@link #toViewByteBuffer()}
     *
     * @since 2.1.2
     */
    ByteBufferArray toViewByteBufferArray();
     ...
     * @since 2.1.2
     */
    ByteBufferArray toViewByteBufferArray(ByteBufferArray array);
    ...
    /**
     * <p>
     * Converts this <code>Buffer</code> to a {@link ByteBuffer} per {@link #toViewByteBuffer(int, int)}
     * and returns a {@link ByteBufferArray} containing the converted {@link ByteBuffer}.
     * </p>
     *
     * @param position the start position within the source <code>buffer</code>
     ...
     *                 {@link ByteBuffer}
     *
     * @return Converts this <code>Buffer</code> to a {@link ByteBuffer} per {@link #toViewByteBuffer(int, int)}
     *         and returns a {@link ByteBufferArray} containing the converted {@link ByteBuffer}.
     *
     * @see {@link #toViewByteBuffer(int, int)}
     *
     * @since 2.1.2
     */
    ByteBufferArray toViewByteBufferArray(int position, int limit);
     ...
     * @since 2.1.2
     */
    ByteBufferArray toViewByteBufferArray(ByteBufferArray array, int position, int limit);
