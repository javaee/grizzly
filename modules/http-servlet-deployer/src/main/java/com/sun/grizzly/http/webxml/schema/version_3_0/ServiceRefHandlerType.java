...
public class ServiceRefHandlerType {
    ...
    protected com.sun.grizzly.http.webxml.schema.version_3_0.String handlerName;
    ...
    protected List<com.sun.grizzly.http.webxml.schema.version_3_0.String> soapRole;
    @XmlElement(name = "port-name")
    protected List<com.sun.grizzly.http.webxml.schema.version_3_0.String> portName;
    @XmlAttribute
     ...
     *     
     */
    public com.sun.grizzly.http.webxml.schema.version_3_0.String getHandlerName() {
        return handlerName;
    }
     ...
     *     
     */
    public void setHandlerName(com.sun.grizzly.http.webxml.schema.version_3_0.String value) {
     ...
     * 
     */
    public List<com.sun.grizzly.http.webxml.schema.version_3_0.String> getSoapRole() {
        if (soapRole == null) {
            soapRole = new ArrayList<com.sun.grizzly.http.webxml.schema.version_3_0.String>();
        }
     ...
     * 
     */
    public List<com.sun.grizzly.http.webxml.schema.version_3_0.String> getPortName() {
        if (portName == null) {
            portName = new ArrayList<com.sun.grizzly.http.webxml.schema.version_3_0.String>();
        }
