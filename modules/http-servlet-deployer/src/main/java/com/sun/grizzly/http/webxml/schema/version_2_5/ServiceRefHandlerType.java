...
public class ServiceRefHandlerType {
    ...
    protected List<com.sun.grizzly.http.webxml.schema.version_2_5.String> portName;
    @XmlAttribute
     ...
     * 
     */
    public List<com.sun.grizzly.http.webxml.schema.version_2_5.String> getPortName() {
        if (portName == null) {
            portName = new ArrayList<com.sun.grizzly.http.webxml.schema.version_2_5.String>();
        }
