...
public class SpdySemanticsTest extends AbstractSpdyTest {
    ...
    public void testRstOnMissedSynReply() throws Exception {
        ...
        try {
            ...
            try {
                ...
                spdyStream.addCloseListener(new CloseListener() {

                    @Override
                    public void onClosed(Closeable closable, CloseReason reason)
                            throws IOException {
                        closeFuture.result(reason.getType());
                    }
                });
    ...
    public void testConnectionTerminated() throws Exception {
        ...
        final FutureImpl<CloseReason> resultFuture = Futures.createSafeFuture();
