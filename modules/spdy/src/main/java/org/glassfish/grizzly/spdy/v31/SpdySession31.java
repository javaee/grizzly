 ...
 */
public final class SpdySession31 extends SpdySession {

    public SpdySession31(final Connection<?> connection,
            final boolean isServer, final SpdyHandlerFilter handlerFilter) {
    ...
    protected SessionOutputSink newOutputSink() {
        return new SessionOutputSink31(this);
    }
    
    @Override
    protected void sendWindowUpdate(final int delta) {
        ((SessionOutputSink31) getOutputSink()).sendWindowUpdate(delta);
    }
}
