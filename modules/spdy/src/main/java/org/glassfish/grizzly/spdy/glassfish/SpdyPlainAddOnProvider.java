...
@Service(name="spdy-plain")
@ContractsProvided({SpdyPlainAddOnProvider.class, AddOn.class})
public class SpdyPlainAddOnProvider extends SpdyAddOn implements ConfigAwareElement<Spdy> {

    public SpdyPlainAddOnProvider() {
        super(SpdyMode.PLAIN);
    }
