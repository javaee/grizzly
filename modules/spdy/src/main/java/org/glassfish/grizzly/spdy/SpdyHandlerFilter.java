...
public class SpdyHandlerFilter extends BaseFilter {
    ...
    private void processInFrame(final Buffer frame) {
        System.out.println("frame [" + frame.get() + ", " + frame.get() + ", " + frame.get()
                + ", " + frame.get() + ", " + frame.get() + ", " + frame.get()
                + ", " + frame.get() + ", " + frame.get() + "]");
    }    
}
