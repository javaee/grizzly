...
public enum SpdyVersion {
    ...
    public SpdySession newSession(final Connection<?> connection,
    ...
    public static SpdyVersion fromString(final String spdyVersion) {
        if (SPDY_3.toString().equalsIgnoreCase(spdyVersion)) {
            return SPDY_3;
        } else if (SPDY_3_1.toString().equalsIgnoreCase(spdyVersion)) {
            return SPDY_3_1;
        }
