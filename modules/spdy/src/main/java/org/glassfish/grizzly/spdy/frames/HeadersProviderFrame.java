...
public abstract class HeadersProviderFrame extends SpdyFrame {
    ...
    public static abstract class HeadersProviderFrameBuilder<T extends HeadersProviderFrameBuilder> extends SpdyFrameBuilder<HeadersProviderFrameBuilder> {

        private final HeadersProviderFrame headersProviderFrame;


        // -------------------------------------------------------- Constructors


        protected HeadersProviderFrameBuilder(SpdyFrame frame) {
            super(frame);
            this.headersProviderFrame = (HeadersProviderFrame) frame;
        }
        ...
        public T compressedHeaders(final Buffer compressedHeaders) {
            headersProviderFrame.compressedHeaders = compressedHeaders;
            return (T) getThis();
        }
