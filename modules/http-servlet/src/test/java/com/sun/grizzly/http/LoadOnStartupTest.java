...
public class LoadOnStartupTest {
	...
	public void loadOnStartupTest() throws Exception {
		...
		sa = new ServletAdapter();
		sa.setProperty(ServletAdapter.LOAD_ON_STARTUP, Boolean.FALSE);
		Assert.assertTrue(!sa.isLoadOnStartup());
		...
		sa = new ServletAdapter();
		sa.setProperty(ServletAdapter.LOAD_ON_STARTUP, "0");
		Assert.assertTrue(sa.isLoadOnStartup());
		
		sa = new ServletAdapter();
		sa.setProperty(ServletAdapter.LOAD_ON_STARTUP, "15");
		Assert.assertTrue(sa.isLoadOnStartup());
