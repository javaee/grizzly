 ...
 */
public class PipelineThreadPoolTest extends TestCase {

    public static void main( String[] args ) {
        PipelineThreadPoolTest test = new PipelineThreadPoolTest();
    ...
    public void testIncreasingWorkerThreadForInfiniteWait() {
        ...
        ExecutorService executorService = new PipelineThreadPool( "GrizzlyWorkerTest",
                                                                  corePoolSize,
                                                                  maxPoolSize,
                                                                  keepAliveTime,
