...
public interface FileOutputBuffer{
    /**
     * Returns <tt>true</tt>, if {@link OutputBuffer} supports file-send mode,
     *         or <tt>false</tt> otherwise.
     * @return <tt>true</tt>, if {@link OutputBuffer} supports file-send mode,
     *         or <tt>false</tt> otherwise.
     */
     ...
     * @param position The position within the file at which the transfer is
     *                 to begin; must be non-negative
     * @param length The maximum number of bytes to be transferred;
     *                 must be non-negative
     * @return number of bytes tranferred
