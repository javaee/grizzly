 ...
 */
public class JDKThreadPool extends ThreadPoolExecutor
    ...
    public JDKThreadPool(int corePoolSize, int maximumPoolSize,
    ...
    private class DefaultWorkerThreadFactory implements ThreadFactory {
        public Thread newThread(Runnable r) {
            Thread thread = new WorkerThreadImpl(JDKThreadPool.this,
                    name + "-WorkerThread(" +
                    workerThreadCounter.getAndIncrement() + ")", r,
                    initialByteBufferSize);
            thread.setUncaughtExceptionHandler(JDKThreadPool.this);
