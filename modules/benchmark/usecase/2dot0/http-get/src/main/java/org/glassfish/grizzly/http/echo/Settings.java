...
public class Settings {
    ...
    public String toString() {
        ...
        return "\nConfiguration:" + "\n-----------------------------------"
                + "\nHost: " + host
                + "\nPort: " + port
                + "\nWorker threads: " + (workerThreads - selectorThreads)
                + "\nSelector threads: " + selectorThreads
                + "\nIOStrategy class: " + strategyClass
                + "\nMonitoring memory: " + isMonitoringMemory
                + "\nStream Write Method: " + ((blocking)
                                                  ? "blocking"
                                                  : "non-blocking")
                + "\nStream Type: " + ((binary)
                                          ? "binary"
