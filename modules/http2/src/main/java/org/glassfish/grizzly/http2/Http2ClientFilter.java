...
public class Http2ClientFilter extends Http2BaseFilter {
    ...
    public NextAction handleConnect(final FilterChainContext ctx) throws IOException {
        ...
        if (sslFilterReg != null) { // use TLS ALPN
            final SSLFilter sslFilter = (SSLFilter) sslFilterReg.filter();
            ...
            ((NIOConnection) connection).registerKeyInterest(SelectionKey.OP_READ);
