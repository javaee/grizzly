...
final class StreamInputBuffer {
    ...
    StreamInputBuffer(final Http2Stream stream) {
        this.stream = stream;
    ...
    private Buffer poll0() throws IOException {
        System.out.println(Thread.currentThread().getName() + " streamId=" + stream.getId() + ": poll0 isClosed=" + isClosed());
        ...
        System.out.println(Thread.currentThread().getName() + " streamId=" + stream.getId() + ": poll0 isClosed=" + isClosed() + " goes poll(timeout)");
        ...
        System.out.println(Thread.currentThread().getName() + " streamId=" + stream.getId() + ": poll0 isClosed=" + isClosed() + " interrupted");
                    throw new IOException("Blocking read was interrupted");
                }

                if (inputElement == null) {
        System.out.println(Thread.currentThread().getName() + " streamId=" + stream.getId() + ": poll0 isClosed=" + isClosed() + " blocking read timeout");
                    // timeout expired
                    throw new IOException("Blocking read timeout");
                } else {
        System.out.println(Thread.currentThread().getName() + " streamId=" + stream.getId() + ": poll0 isClosed=" + isClosed() + " blocking read success");
