...
//                +-------------------------------+
//
public class LiteralNeverIndexed implements BinaryRepresentation {
    ...
    private LiteralNeverIndexed() {
    }

    public static boolean matches(byte sig) {
        return (sig & 0b11110000) == 0b00010000;
    }
    ...
    public static void write(int index, String value, OutputStream destination,
            boolean useHuffman) throws IOException {
        writeInteger(destination, index, 4, 0b00010000);
        writeString(destination, value, useHuffman);
    }

    public static void write(String name, String value, OutputStream destination,
            boolean useHuffman) throws IOException {
        writeInteger(destination, 0, 4, 0b00010000);
