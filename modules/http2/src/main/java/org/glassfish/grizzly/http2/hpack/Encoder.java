...
import org.glassfish.grizzly.http2.hpack.HeaderFieldTable.EncTable;

/**
 * Place where {@link hpack.EncodingStrategy} meets the encoding state.
 */
...
public class Encoder {
    ...
    private final EncTable table;

    public Encoder(EncodingStrategy enc, EncTable table) {
        this.enc = Objects.requireNonNull(enc, "enc == null");
    ...
    public void encode(String name, String value,
        ...
        enc.encode(name, value, destination, table);
    }
}
