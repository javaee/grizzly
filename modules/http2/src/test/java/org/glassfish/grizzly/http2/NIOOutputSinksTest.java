...
public class NIOOutputSinksTest extends AbstractHttp2Test {
    ...
    public void testBinaryOutputSink() throws Exception {
        ...
        clientTransport.setFilterChain(clientChain);
    ...
    public void testWriteExceptionPropagation() throws Exception {
        ...
        listener.registerAddOn(new AddOn() {
            ...
            public void setup(NetworkListener networkListener, FilterChain filterChain) {
                final FilterReg transportFilterReg = filterChain.getRegByType(TransportFilter.class);
                filterChain.addAfter(transportFilterReg.filter(), new BaseFilter() {
    ...
    public void testWritePossibleReentrants() throws Exception {
        ...
        final HttpHandler httpHandler = new HttpHandler() {
            ...
            final ThreadLocal<Integer> reentrantsCounter = ThreadLocal.withInitial(() -> -1);
...
//    }
    ...
    private void setInitialHttp2WindowSize(final FilterChain filterChain,
        ...
        final FilterReg http2BaseFilterReg = filterChain.getRegByType(Http2BaseFilter.class);
        final Http2BaseFilter http2Filter =
                (Http2BaseFilter) http2BaseFilterReg.filter();
