...
public interface ICommand {
	 ...
	 */
	ICommandRequest process(String query, ClientConnectionHandler clientConnectionHandler);
	
	/**
	 * 
	 * @param manager QuoteManager
	 */
	void setQuoteManager(QuoteManager manager);
	...
	/**
	 * 
	 * @param handler that will receive the updates
	 */
	 ...
	 */
	void setSubscription(String quoteSubscription);
}
