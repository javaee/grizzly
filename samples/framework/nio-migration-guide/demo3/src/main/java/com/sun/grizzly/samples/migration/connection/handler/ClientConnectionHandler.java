 ...
 *
 */
public class ClientConnectionHandler implements Comparable<ClientConnectionHandler> {
	 ...
	 */
	public ClientConnectionHandler(QuoteManager manager, SelectionKey key, SelectorHandler selectorHandler){
		f_manager = manager;
		f_key = key;
	...
	/**
	 * Need this function because of the SkipList.
	 */
	public int compareTo(ClientConnectionHandler arg0) {
		return 0;
	}
