...
public class MessageError extends MessageBase{
    ...
    public MessageError() {
        setMessageType(Message_Error);
    }


    public MessageError(String message,ErrorCode code) {
        this();
    ...
    /**
     * 
     * @return  errorHappendHere true if error occured here
     */
    public boolean isErrorHappendHere() {
        return errorHappendHere;
    }

    /**
     *
     * @param errorHappendHere if true error occured while parsing message on this side.
     */
    public void setErrorHappendHere(boolean errorHappendHere) {
        this.errorHappendHere = errorHappendHere;
    }
}
