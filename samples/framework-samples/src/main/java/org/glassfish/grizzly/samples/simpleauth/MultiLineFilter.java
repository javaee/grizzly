...
public class MultiLineFilter extends BaseFilter {
    ...
    /**
     * The method is called once we have received {@link String} line list.
     * 
     * Filter check if the list has {@link MultiLinePacket} terminating line, if yes -
     ...
     * terminating line - we add these lines to a {@link MultiLinePacket}
