...
public class AddServerMessageFilter extends BaseFilter {
    ...
    public NextAction handleRead(final FilterChainContext ctx) throws IOException {
        ...
        // If the available data is not enough to parse the message - shutdownNow
     ...
     *
     * We override this method to perform AddResponseMessage -> Buffer transformation.
     *
     * @param ctx Context of {@link FilterChainContext} processing
     * @return the next action
     * @throws java.io.IOException
    ...
    public NextAction handleWrite(final FilterChainContext ctx) throws IOException {
        ...
        final int result = addResponseMessage.getResult();
