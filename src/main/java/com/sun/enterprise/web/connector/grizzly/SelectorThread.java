...
public class SelectorThread extends Thread implements MBeanRegistration{
    ...
    /**
     * Maximum number of <code>Selector</code>s in the SelectorFactory pool
     */
   ...
   /**
    ...
    public void enableSelectionKeys() {
        ...
        do {
            ...
            if (!keepAlivePipeline.trap(selectionKey)){
                /**
    ...
    protected void doSelect(){
        ...
        try{
            ...
            if (msg != null && msg.equals("Too many open files")){
                logger.log(Level.SEVERE,"Running out of operating systems file descriptors. " +
